...
class Agent:
    ...
    def _create_random_shapes(self):
        ...
        for _ in range(self.shapes_per_agent):
            shape_class = random.choice([Triangle])   # You can add Circle and Rectangle back to this list if you want to use them
    ...
    def mutate(self):
        ...
        num_to_mutate = max(1, int(self.shapes_per_agent * 0.25))
